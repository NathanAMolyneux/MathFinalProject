      ...
      <aside className="hidden md:fixed md:top-16 md:left-0 md:h-[calc(100vh-4rem)] md:w-64 md:border-r md:border-gray-100 md:bg-white md:px-4 md:py-6 md:z-40">
        ...
        <div className="mt-8 pt-6 border-t border-gray-100">
          ...
          <p className="text-xs text-gray-600">
            Use this page to translate between Cartesian (x, y) and polar (r, θ),
            then practice with the examples below.
          </p>
        </div>
      </aside>
            ...
            <div>
              ...
              <ul className="text-gray-700 text-sm leading-relaxed list-disc list-inside space-y-1 text-[16.5px]">
                ...
                <li>
                  ...
                  <li>
                  Using polar coordinates to sketch and analyze curves 
                </li>
              </ul>
            </div>
...
<div className="w-full flex justify-center my-6">
  ...
  />
              ...
              {/* Step 2: Compute theta with stacked fraction */}
              <div className="mb-3">
                <p className="text-sm text-gray-800 font-semibold mb-1">
                ...
                <p className="text-sm text-gray-700 leading-relaxed mt-1">
                  Since (3, 4) is in Quadrant I (x &gt; 0, y &gt; 0), this angle
                  is already the correct principal angle.
                </p>
              </div>
...
<div className="mt-8 space-y-4">
  ...
  <p className="text-gray-700 text-sm leading-relaxed text-[16.5px]">
    Before sketching polar curves, it’s important to reinforce a few ideas about how
    polar coordinates work and how points and curves behave in the polar plane.
  </p>
  ...
  <p className="text-gray-700 text-sm leading-relaxed text-[16.5px]">
    Any point can be written in infinitely many ways. Adding 2π to the angle
    or switching to a negative radius gives different representations of the same point:
    (r, θ), (r, θ + 2πk), or (−r, θ + π).
  </p>
  ...
  <p className="text-gray-700 text-sm leading-relaxed text-[16.5px]">
    Equations using sin θ often have vertical symmetry.  
    Equations using cos θ often have horizontal symmetry.  
    Checking symmetry makes graphs easier to understand before drawing.
  </p>
  ...
  <p className="text-gray-700 text-sm leading-relaxed text-[16.5px]">
    When sketching r = f(θ), plug in important angles such as 0, π/2, π, and 3π/2.
    These values reveal how the curve grows, shrinks, or crosses the origin.
  </p>
  ...
  <p className="text-gray-700 text-sm leading-relaxed text-[16.5px]">
    Remember that r measures distance from the origin and θ is the angle from the
    positive x-axis. These relationships help confirm whether points are placed
    correctly when switching between coordinate systems.
  </p>
...
<div className="mt-4 p-4 rounded-xl border border-red-100 bg-red-50/40">
  ...
  <p className="text-sm text-gray-700 leading-relaxed mb-2 text-[16px]">
    We are given a polar equation r = 1 + sin θ. We want to understand the
    shape of this curve and how it is traced in the polar plane.
  </p>
  ...
  <div className="mb-3">
    ...
    <p className="text-sm text-gray-700 leading-relaxed mt-1">
      ...
      <strong>limaçon</strong>. Because a and b are both 1, the curve is a
      special limaçon called a <strong>cardioid</strong>.
    </p>
  </div>

  {/* Step 2: Evaluate key angles */}
  <div className="mb-3">
    <p className="text-sm text-gray-800 font-semibold mb-1">
    ...
    <p className="text-sm text-gray-700 leading-relaxed mt-1">
      The point with largest radius is at θ = π/2 (straight up), and the curve
      passes through the origin when θ = 3π/2.
    </p>
  </div>

{/* Step 3: Describe symmetry and shape */}
<div className="mb-3">
  <p className="text-sm text-gray-800 font-semibold mb-1">
    Step 3: Describe symmetry and overall shape
  </p>
  <p className="text-sm text-gray-700 leading-relaxed">
    Because the equation uses sin θ, the graph is symmetric about the vertical
    (y)-axis. As θ runs from 0 to 2π, the radius grows from 1 up to 2, then
    shrinks to 0 at the origin, and returns to 1. This produces a 
    <strong>heart-shaped cardioid</strong> with its “bump” centered above the
    origin.
  </p>

  {/* Graph Image for Example 2 */}
  ...
  <div className="mt-2">
    ...
    <p className="text-sm text-gray-700 leading-relaxed">
      The polar curve r = 1 + sin θ is a cardioid, symmetric about the vertical
      axis, with maximum radius 2 at θ = π/2 and passing through the origin at
      θ = 3π/2.
    </p>
  </div>
</div>
              ...
              <ul className="text-gray-700 text-sm list-disc list-inside space-y-1 mt-2">
                ...
                <li>
                  ...
                  of 2π.
                                ...
                                <li>
                    Polar curves can be sketched by evaluating r at key angles 
                </li>
              </ul>
            </div>
          </section>
