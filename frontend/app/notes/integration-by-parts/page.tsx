      ...
      <aside className="hidden md:fixed md:top-16 md:left-0 md:h-[calc(100vh-4rem)] md:w-64 md:border-r md:border-gray-100 md:bg-white md:px-4 md:py-6 md:z-40">
        <div className="mb-6">
          ...
          <nav className="space-y-1">
            ...
            <Link
              ...
              className="flex items-center px-3 py-2 rounded-lg text-sm font-medium text-red-700 bg-red-50/70 border border-red-100"
            >
        ...
        <div className="mt-8 pt-6 border-t border-gray-100">
          ...
          <p className="text-xs text-gray-600">
            Integration by parts is most useful for products like x·sin(x),
            x·eˣ, or ln(x)·1 that don&apos;t work well with substitution.
          </p>
        </div>
      </aside>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="mb-10">
            ...
            <p className="text-sm md:text-base text-gray-600">
              Learn a new technique to evaluate integrals of products like{" "}
              ∫ x sin(x) dx, ∫ ln(x) dx, and ∫ t² eᵗ dt that basic substitution
              can&apos;t handle. 
            </p>
          </header>
          ...
          <section className="bg-white border border-red-100 rounded-2xl p-6 shadow-sm space-y-8">
            ...
            <div>
              ...
              <ul className="text-gray-700 text-sm leading-relaxed list-disc list-inside space-y-1 text-[16.5px]">
                ...
                <li>
                  Choose appropriate u and dv for a given product integrand.
                </li>
                <li>
            ...
            <div className="mt-2 p-4 rounded-xl border border-red-100 bg-red-50/40">
              ...
              <div className="mb-3">
                ...
                <p className="text-sm text-gray-700 leading-relaxed mt-1">
                  We choose u = x so that its derivative du = dx becomes simpler,
                  and we choose dv = sin(x) dx because we know its antiderivative
                  v = −cos(x).
                </p>
              </div>
